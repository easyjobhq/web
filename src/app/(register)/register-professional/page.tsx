...
function RegisterProfessional() {
    ...
    const onSubmit = async (event: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
        ...
        if (!name || !last_name || !email || !phone_number || !password || !photo || !serviceId || !cityId || !languageId || !specialityId) {
            alert("All fields are required");
        } else {
            await register(name, last_name, email, phone_number, password, photo, serviceId, languageId, cityId, specialityId,  "Prof")
    ...
    return (
        ...
        <section className=" p-4 shadow-md bg-white rounded-lg">
            <div className="md:flex">
                <h2 className="tracking-wide font-semibold mb-6 ml-2 text-2xl">Crea tu perfil profesional</h2>
            </div>
            <form>
                <div className="md:flex mb-8">
                    <div className="md:flex-1 mt-2 mb:mt-0 md:px-3">
                        ...
                        <div className="mb-4">
                            <label className="block tracking-wide text-md ">Contraseña</label>
                        ...
                        <div className="flex items-center justify-center">
                            <p className='text-sm font-light mt-4 mr-1'>¿Eres un cliente?</p>
